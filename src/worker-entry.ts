...
function filterToolsByContent(allTools: any[], messageContent: string): any[] {
  ...
  const filteredTools = allTools.filter(tool => {
    ...
    // Check if the tool name or description contains relevant keywords
           ...
           toolDesc.includes('calendar') ||
           toolName.includes('event') ||
           toolDesc.includes('event') ||
           toolName.includes('ical') ||
           toolDesc.includes('ical');
  });
